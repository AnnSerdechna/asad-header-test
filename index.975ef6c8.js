...
/* eslint-disable no-param-reassign */ const searchTopBtn = document.querySelector('.navTop__searchBtn');
...
searchTopBtn.addEventListener('click', (event)=>{
    if (searchForm.style.display === 'flex') searchForm.style.display = 'none';
    else {
...
},{}]},["7fmqN","8lqZg"], "8lqZg", "parcelRequire58a6")
